...
const TOOLS = [
    ...
    },
    {
        ...
        description: "Scan and rank multiple prediction markets by tradeable edge. Applies the market filter (skip rules remove low-quality markets, boost rules amplify high-edge categories). Returns ranked opportunities with Kelly sizing and filter status. Costs $0.10 via x402 micropayment (USDC on Base).",
        inputSchema: {
            type: "object",
            properties: {
                markets: {
